...
import exception.InformationDuplicateException;
...
public class Menu {
    ...
    MainServiceService mainServiceService = ApplicationContext.getMainServiceService();
    ...
    CommentService commentService = ApplicationContext.getCommentService();
    ...
    public void adminSpecialistProcess(Admin admin) {
        ...
        switch (choose) {
            ...
            case 2 -> assignSpecialistToSubService(admin);
        ...
        try {
            ...
            if (customerService.validate(customer)) {
                ...
                for (Address address : addresses) {
                    ...
                    addressService.saveOrUpdate(address); // Save the address with customer ID
                }
                try {
    ...
    public void approveSpecialist(Admin admin) {
        try {
            ...
            Specialist savedSpecialist = specialistService.findById(specialistId);
    ...
    public void assignSpecialistToSubService(Admin admin) {
        ...
        try {
            ...
            // Get specialist ID from admin
            System.out.println("Enter the ID of the specialist to assign sub-services:");
            Long specialistId = Long.parseLong(scanner.nextLine());
            ...
            // Get subservice IDs from admin to assign to specialist
            ...
            for (String subServiceId : subServiceIds) {
                SubService subService = subServiceService.findById(Long.parseLong(subServiceId.trim()));
                if (subService != null) {
            ...
            // Assign sub-services to specialist and update
            specialistService.updateSpecialistWithSubServices(specialist.getId(), subServiceSet);
            System.out.println("Specialist " + specialist.getFirstName() + " " + specialist.getLastName() + " has been assigned to the selected sub-services.");
            adminSpecialistProcess(admin);
    ...
    public void signupSpecialist() {
        ...
        try {
            ...
            if (specialistService.validate(specialist)) {
                Specialist savedSpecialist = specialistService.saveOrUpdate(specialist);
                try {
                    TimeUnit.SECONDS.sleep(5);
    ...
    public void addMainService(Admin admin) {
        try {
            ...
            MainService savedService = mainServiceService.saveOrUpdate(mainService);
    ...
    public void addSubService(Admin admin) {
        ...
        try {
            ...
            MainService mainServiceOne = mainService;
    ...
    public void updateProfileSpecialist() {
        ...
        try {
           ...
           Specialist specialist = specialistService.findById(specialistId);
            ...
            Specialist specialistOne = specialist;
            ...
            // Update specialist
            specialistOne.setUsername(newUsername);
            specialistOne.setPassword(newPassword);
            specialistOne.setYearsOfExperience(newYearsOfExperience);
            specialistOne.setEmail(newEmail);
    ...
    public void updateMainService() {
        try {
            ...
            // Update main service
          MainService mainService = mainServiceService.findById(serviceId);
            if (mainService != null) {
                MainService service = mainService;
                service.setServiceName(newName);

                MainService updatedService = mainServiceService.saveOrUpdate(service);
    ...
    public void updateSubService() {
        try {
            ...
            List<SubService> subServices = subServiceService.findByMainService(mainServiceOne);
            System.out.println("Available Sub Services:");
            for (SubService subService : subServices) {
           ...
           SubService subService = subServiceService.findById(subServiceId);
            ...
            SubService subServiceOne = subService;
            ...
            subServiceOne.setSubserviceName(newName);
            subServiceOne.setPrice(newPrice);
            subServiceOne.setDescription(newDescription);

            SubService updatedSubService = subServiceService.saveOrUpdate(subService);
    ...
    public void createOrder(Customer customer) {
        try {
            ...
            MainService mainService = mainServiceService.findByServiceName(serviceName);
            if (mainService == null) {
                System.out.println("Service not found!");
                orderMenu(customer);
                return;
            ...
            String subServiceName = scanner.nextLine();
           SubService subService = subServiceService.findBySubserviceNameAndService(subServiceName, service);
            if (subService == null) {
                System.out.println("Sub-service not found!");
                orderMenu(customer);
                return;
            ...
            List<Specialist> specialists = specialistService.findBySubService(subServiceOne);
            ...
            for (int i = 0; i < customerAddresses.size(); i++) {
                ...
                System.out.println(i + 1 + ". " + address.getCity() + ", " + address.getState() + ", " + address.getAddressLine() + ", " + address.getPostalCode());
            }
    ...
    public void addComment(Customer customer) {
        try {
            ...
            commentService.saveOrUpdate(specialistComment);
    ...
    public void updateComment(Customer customer) {
        try {
            ...
            commentService.saveOrUpdate(selectedComment);
